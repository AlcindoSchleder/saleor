...
class PagSeguroGatewayPlugin(BasePlugin):
    ...
    CONFIG_STRUCTURE = {
        ...
        "Public API key": {
            "type": ConfigurationTypeField.STRING,
            "help_text": pgettext_lazy(
                "Plugin help text", "Provide PagSeguro public API key"
            ),
        ...
        "Secret API key": {
            "type": ConfigurationTypeField.STRING,
            "help_text": pgettext_lazy(
                "Plugin help text", "Provide PagSeguro secret API key"
            ),
        ...
        "Merchant ID": {
            "type": ConfigurationTypeField.STRING,
            "help_text": pgettext_lazy(
                "Plugin help text", "Provide PagSeguro merchant ID"
            ),
        ...
        "Use sandbox": {
            ...
            "help_text": pgettext_lazy(
                "Plugin help text",
                "Determines if Saleor should use PagSeguro sandbox API.",
            ),
    ...
    def _get_default_configuration(cls):
        defaults = {
            ...
            "active": False,
            "configuration": [
                {"name": "Template path", "value": "order/payment/pagseguro.html"},
